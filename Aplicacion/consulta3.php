		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li><a href="consulta3.php">Refrescar</a></li>
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Consulta No. 3</h1>
				</header>
				<center>
    ...
    if (file_exists($archivo)) {
        ...
        exit;
					...
					if(isset($_POST['generar'])){
						...
						<body>
											<center><h1>Consulta No. 3</h1></center>
											<p>Reporte donde se detalla el nombre, total ganado durante el dia actual, total de horas trabajadas durante el dia actual. '.date("d/m/y").'.<p>
						...
						<div align="center">
							...
							$sql = "SELECT nombre,total,total_horas FROM ReporteDiario;";
							...
							if ($result->num_rows > 0) {
							     while($row = $result->fetch_assoc()) {
								    ...
								    download_file("reportes/reporte.pdf", "reporte3.pdf");
							} else {
							    echo "<script>
					...
					if ($result->num_rows > 0) {
					     ...
					     while($row = $result->fetch_assoc()) {
								echo "
								    ...
								    cell2.innerHTML = \"$row[total]\";
								    cell3.innerHTML = \"$row[total_horas]\";
								 	";
					     }
					     	echo "}
					     		</script>";
